...
public class Piece : MonoBehaviour
{
    ...
    protected void PopulatePieceData()
    {
        ...
        KICKTABLE_MONO[(int)RotState.NAT, (int)RotState.CWI] = new Vector2Int[] { new Vector2Int(2, 0), new Vector2Int(2, -1), new Vector2Int(1, -1), new Vector2Int(2, -2), new Vector2Int(1, -2), new Vector2Int(0, -2), new Vector2Int(0, 0) };
        KICKTABLE_MONO[(int)RotState.CWI, (int)RotState.NAT] = new Vector2Int[] { new Vector2Int(-2, 0), new Vector2Int(-2, -1), new Vector2Int(-1, -1), new Vector2Int(-2, -2), new Vector2Int(-1, -2), new Vector2Int(0, -2), new Vector2Int(0, 0) };
        KICKTABLE_MONO[(int)RotState.CWI, (int)RotState.TWO] = new Vector2Int[] { new Vector2Int(2, 0), new Vector2Int(2, -1), new Vector2Int(1, -1), new Vector2Int(2, -2), new Vector2Int(1, -2), new Vector2Int(0, -2), new Vector2Int(0, 0) };
        KICKTABLE_MONO[(int)RotState.TWO, (int)RotState.CWI] = new Vector2Int[] { new Vector2Int(-2, 0), new Vector2Int(-2, -1), new Vector2Int(-1, -1), new Vector2Int(-2, -2), new Vector2Int(-1, -2), new Vector2Int(0, -2), new Vector2Int(0, 0) };
        KICKTABLE_MONO[(int)RotState.TWO, (int)RotState.CCW] = new Vector2Int[] { new Vector2Int(2, 0), new Vector2Int(2, -1), new Vector2Int(1, -1), new Vector2Int(2, -2), new Vector2Int(1, -2), new Vector2Int(0, -2), new Vector2Int(0, 0) };
        KICKTABLE_MONO[(int)RotState.CCW, (int)RotState.TWO] = new Vector2Int[] { new Vector2Int(-2, 0), new Vector2Int(-2, -1), new Vector2Int(-1, -1), new Vector2Int(-2, -2), new Vector2Int(-1, -2), new Vector2Int(0, -2), new Vector2Int(0, 0) };
        KICKTABLE_MONO[(int)RotState.CCW, (int)RotState.NAT] = new Vector2Int[] { new Vector2Int(2, 0), new Vector2Int(2, -1), new Vector2Int(1, -1), new Vector2Int(2, -2), new Vector2Int(1, -2), new Vector2Int(0, -2), new Vector2Int(0, 0) };
        KICKTABLE_MONO[(int)RotState.NAT, (int)RotState.CCW] = new Vector2Int[] { new Vector2Int(-2, 0), new Vector2Int(-2, -1), new Vector2Int(-1, -1), new Vector2Int(-2, -2), new Vector2Int(-1, -2), new Vector2Int(0, -2), new Vector2Int(0, 0) };
